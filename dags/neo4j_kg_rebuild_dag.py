...
- KG_REBUILD_START_DATE: "YYYY-MM-DD" (필수)
- KG_REBUILD_END_DATE: "YYYY-MM-DD" (필수)
...
from modules.neo4j.neo4j_operators import rebuild_kg_from_postgres_range
...
def _rebuild(**_context):
    ...
    if not start_date or not end_date:
        raise ValueError(
            "Missing required Airflow Variables: KG_REBUILD_START_DATE, KG_REBUILD_END_DATE"
        )

    return rebuild_kg_from_postgres_range(
